...
mixin _$SimulcastDto {
 ...
 String get uuid; String get season; int get year; String get slug; String get label;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SimulcastDto&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.season, season) || other.season == season)&&(identical(other.year, year) || other.year == year)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.label, label) || other.label == label));
}
...
@useResult
$Res call({
 String uuid, String season, int year, String slug, String label
});
...
/// Create a copy of SimulcastDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? season = null,Object? year = null,Object? slug = null,Object? label = null,}) {
...
class _SimulcastDto implements SimulcastDto {
  const _SimulcastDto({required this.uuid, required this.season, required this.year, required this.slug, required this.label});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SimulcastDto&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.season, season) || other.season == season)&&(identical(other.year, year) || other.year == year)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.label, label) || other.label == label));
}
...
/// Create a copy of SimulcastDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? season = null,Object? year = null,Object? slug = null,Object? label = null,}) {
