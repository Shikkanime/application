...
mixin _$EpisodeVariantDto {
 ...
 String get uuid; String get releaseDateTime; PlatformDto get platform; String get audioLocale; String get identifier; String get url; bool get uncensored;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EpisodeVariantDto&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.releaseDateTime, releaseDateTime) || other.releaseDateTime == releaseDateTime)&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.audioLocale, audioLocale) || other.audioLocale == audioLocale)&&(identical(other.identifier, identifier) || other.identifier == identifier)&&(identical(other.url, url) || other.url == url)&&(identical(other.uncensored, uncensored) || other.uncensored == uncensored));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,releaseDateTime,platform,audioLocale,identifier,url,uncensored);
...
@useResult
$Res call({
 String uuid, String releaseDateTime, PlatformDto platform, String audioLocale, String identifier, String url, bool uncensored
});
...
/// Create a copy of EpisodeVariantDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? releaseDateTime = null,Object? platform = null,Object? audioLocale = null,Object? identifier = null,Object? url = null,Object? uncensored = null,}) {
...
as PlatformDto,audioLocale: null == audioLocale ? _self.audioLocale : audioLocale // ignore: cast_nullable_to_non_nullable
as String,identifier: null == identifier ? _self.identifier : identifier // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,uncensored: null == uncensored ? _self.uncensored : uncensored // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of EpisodeVariantDto
...
class _EpisodeVariantDto implements EpisodeVariantDto {
  const _EpisodeVariantDto({required this.uuid, required this.releaseDateTime, required this.platform, required this.audioLocale, required this.identifier, required this.url, required this.uncensored});
...
@override final  String audioLocale;
@override final  String identifier;
@override final  String url;
@override final  bool uncensored;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EpisodeVariantDto&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.releaseDateTime, releaseDateTime) || other.releaseDateTime == releaseDateTime)&&(identical(other.platform, platform) || other.platform == platform)&&(identical(other.audioLocale, audioLocale) || other.audioLocale == audioLocale)&&(identical(other.identifier, identifier) || other.identifier == identifier)&&(identical(other.url, url) || other.url == url)&&(identical(other.uncensored, uncensored) || other.uncensored == uncensored));
}
...
/// Create a copy of EpisodeVariantDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? releaseDateTime = null,Object? platform = null,Object? audioLocale = null,Object? identifier = null,Object? url = null,Object? uncensored = null,}) {
