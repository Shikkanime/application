...
mixin _$SeasonDto {
 ...
 int get number; String get lastReleaseDateTime;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SeasonDto&&(identical(other.number, number) || other.number == number)&&(identical(other.lastReleaseDateTime, lastReleaseDateTime) || other.lastReleaseDateTime == lastReleaseDateTime));
}
...
@useResult
$Res call({
 int number, String lastReleaseDateTime
});
...
/// Create a copy of SeasonDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? number = null,Object? lastReleaseDateTime = null,}) {
  return _then(_self.copyWith(
number: null == number ? _self.number : number // ignore: cast_nullable_to_non_nullable
as int,lastReleaseDateTime: null == lastReleaseDateTime ? _self.lastReleaseDateTime : lastReleaseDateTime // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SeasonDto&&(identical(other.number, number) || other.number == number)&&(identical(other.lastReleaseDateTime, lastReleaseDateTime) || other.lastReleaseDateTime == lastReleaseDateTime));
}
...
/// Create a copy of SeasonDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? number = null,Object? lastReleaseDateTime = null,}) {
