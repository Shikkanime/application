...
mixin _$EpisodeMappingDto {
 ...
 String get uuid; AnimeDto? get anime; String get releaseDateTime; String get lastReleaseDateTime; String get lastUpdateDateTime; String get episodeType; int get season; int get number; int get duration; String? get title; String? get description; String get image; List<EpisodeVariantDto>? get variants; List<PlatformDto>? get platforms; List<String>? get langTypes; String get status;
...
@useResult
$Res call({
 String uuid, AnimeDto? anime, String releaseDateTime, String lastReleaseDateTime, String lastUpdateDateTime, String episodeType, int season, int number, int duration, String? title, String? description, String image, List<EpisodeVariantDto>? variants, List<PlatformDto>? platforms, List<String>? langTypes, String status
});
...
/// Create a copy of EpisodeMappingDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? anime = freezed,Object? releaseDateTime = null,Object? lastReleaseDateTime = null,Object? lastUpdateDateTime = null,Object? episodeType = null,Object? season = null,Object? number = null,Object? duration = null,Object? title = freezed,Object? description = freezed,Object? image = null,Object? variants = freezed,Object? platforms = freezed,Object? langTypes = freezed,Object? status = null,}) {
...
class _EpisodeMappingDto implements EpisodeMappingDto {
  const _EpisodeMappingDto({required this.uuid, required this.anime, required this.releaseDateTime, required this.lastReleaseDateTime, required this.lastUpdateDateTime, required this.episodeType, required this.season, required this.number, required this.duration, required this.title, required this.description, required this.image, required final  List<EpisodeVariantDto>? variants, required final  List<PlatformDto>? platforms, required final  List<String>? langTypes, required this.status}): _variants = variants,_platforms = platforms,_langTypes = langTypes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EpisodeMappingDto&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.anime, anime) || other.anime == anime)&&(identical(other.releaseDateTime, releaseDateTime) || other.releaseDateTime == releaseDateTime)&&(identical(other.lastReleaseDateTime, lastReleaseDateTime) || other.lastReleaseDateTime == lastReleaseDateTime)&&(identical(other.lastUpdateDateTime, lastUpdateDateTime) || other.lastUpdateDateTime == lastUpdateDateTime)&&(identical(other.episodeType, episodeType) || other.episodeType == episodeType)&&(identical(other.season, season) || other.season == season)&&(identical(other.number, number) || other.number == number)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.image, image) || other.image == image)&&const DeepCollectionEquality().equals(other._variants, _variants)&&const DeepCollectionEquality().equals(other._platforms, _platforms)&&const DeepCollectionEquality().equals(other._langTypes, _langTypes)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,anime,releaseDateTime,lastReleaseDateTime,lastUpdateDateTime,episodeType,season,number,duration,title,description,image,const DeepCollectionEquality().hash(_variants),const DeepCollectionEquality().hash(_platforms),const DeepCollectionEquality().hash(_langTypes),status);
...
/// Create a copy of EpisodeMappingDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? anime = freezed,Object? releaseDateTime = null,Object? lastReleaseDateTime = null,Object? lastUpdateDateTime = null,Object? episodeType = null,Object? season = null,Object? number = null,Object? duration = null,Object? title = freezed,Object? description = freezed,Object? image = null,Object? variants = freezed,Object? platforms = freezed,Object? langTypes = freezed,Object? status = null,}) {
