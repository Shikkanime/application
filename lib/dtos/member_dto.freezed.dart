...
mixin _$MemberDto {
 ...
 String get uuid; String get token; String get creationDateTime; String get lastUpdateDateTime; bool get isPrivate; String? get email; List<String> get followedAnimes; List<String> get followedEpisodes; int get totalDuration; int get totalUnseenDuration; bool get hasProfilePicture;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,token,creationDateTime,lastUpdateDateTime,isPrivate,email,const DeepCollectionEquality().hash(followedAnimes),const DeepCollectionEquality().hash(followedEpisodes),totalDuration,totalUnseenDuration,hasProfilePicture);
...
@useResult
$Res call({
 String uuid, String token, String creationDateTime, String lastUpdateDateTime, bool isPrivate, String? email, List<String> followedAnimes, List<String> followedEpisodes, int totalDuration, int totalUnseenDuration, bool hasProfilePicture
});
...
/// Create a copy of MemberDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? token = null,Object? creationDateTime = null,Object? lastUpdateDateTime = null,Object? isPrivate = null,Object? email = freezed,Object? followedAnimes = null,Object? followedEpisodes = null,Object? totalDuration = null,Object? totalUnseenDuration = null,Object? hasProfilePicture = null,}) {
...
class _MemberDto implements MemberDto {
  const _MemberDto({required this.uuid, required this.token, required this.creationDateTime, required this.lastUpdateDateTime, required this.isPrivate, required this.email, required this.followedAnimes, required this.followedEpisodes, required this.totalDuration, required this.totalUnseenDuration, required this.hasProfilePicture});
