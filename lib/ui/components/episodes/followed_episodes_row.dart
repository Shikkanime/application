...
import 'package:application/ui/components/episodes/followed_episode_component.dart';
import 'package:application/ui/components/episodes/followed_episode_loader_component.dart';
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                if (snapshot.data!.isEmpty &&
                  ...
                  HorizontalListView(
                    scrollController:
                        FollowedEpisodeController.instance.scrollController,
                    spacing: 0,
                    children: list,
                  ),
              ],
