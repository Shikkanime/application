...
class NotificationThrottler {
  ...
  static bool isCallThrottled() {
    if (Constant.maxServerSendsPerDay <= 0) {
    ...
    final int slotLengthSec = (dayInSeconds ~/ Constant.maxServerSendsPerDay)
        .clamp(1, dayInSeconds);
    ...
    final int currentSlot = (secondsSinceMidnight ~/ slotLengthSec).clamp(
      0,
      Constant.maxServerSendsPerDay - 1,
    );
